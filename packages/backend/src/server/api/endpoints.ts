...
import * as ep___admin_staff_add from './endpoints/admin/user_roles/staff-add.js';
import * as ep___admin_staff_remove from './endpoints/admin/user_roles/staff-remove.js';
import * as ep___admin_plus_add from './endpoints/admin/user_roles/plus-add.js';
import * as ep___admin_plus_remove from './endpoints/admin/user_roles/plus-remove.js';
import * as ep___admin_tanslator_add from './endpoints/admin/user_roles/translator-add.js';
import * as ep___admin_tanslator_remove from './endpoints/admin/user_roles/translator-remove.js';
import * as ep___admin_verify_add from './endpoints/admin/user_roles/verified-add.js';
import * as ep___admin_verify_remove from './endpoints/admin/user_roles/verified-remove.js';
...
import * as ep___admin_subscription_manage from './endpoints/admin/subscription/manage.js';
import * as ep___admin_subscription_cleanupExpired from './endpoints/admin/subscription/cleanup-expired.js';
import * as ep___admin_resetPassword from './endpoints/admin/reset-password.js';
import * as ep___admin_resolveAbuseUserReport from './endpoints/admin/resolve-abuse-user-report.js';
import * as ep___admin_sendEmail from './endpoints/admin/send-email.js';
import * as ep___admin_mass_email from './endpoints/admin/mass-email.js';
import * as ep___admin_add_trial_user from './endpoints/admin/stripe/add-trial-user.js';
import * as ep___admin_remove_trial_user from './endpoints/admin/stripe/remove-trial-user.js';
...
import * as ep___app_delete from './endpoints/app/delete.js';
...
import * as ep___barktres_startSession from './endpoints/barktres/start-session.js';
import * as ep___barktres_submitScore from './endpoints/barktres/submit-score.js';
import * as ep___barktres_leaderboard from './endpoints/barktres/leaderboard.js';
import * as ep___barktres_myScores from './endpoints/barktres/my-scores.js';
...
import * as ep___channels_archive from './endpoints/channels/archive.js';
import * as ep___channels_ban_user from './endpoints/channels/ban-user.js';
import * as ep___channels_pin from './endpoints/channels/pin.js';
import * as ep___channels_unarchive from './endpoints/channels/un-archive.js';
import * as ep___channels_unban_user from './endpoints/channels/unban-user.js';
import * as ep___channels_unpin from './endpoints/channels/unpin.js';
import * as ep___channels_user_role_add from './endpoints/channels/user-role-add.js';
import * as ep___channels_role_remove from './endpoints/channels/user-role-remove.js';
import * as ep___channels_ban_list from './endpoints/channels/ban-list.js';
import * as ep___channels_admin_list from './endpoints/channels/admin-list.js';
import * as ep___channels_mod_list from './endpoints/channels/mod-list.js';
...
import * as ep___contacts_discover from './endpoints/contacts/discover.js';
import * as ep___contacts_stats from './endpoints/contacts/stats.js';
import * as ep___contacts_import from './endpoints/contacts/import.js';
import * as ep___contacts_inferred_friends from './endpoints/contacts/inferred-friends.js';
import * as ep___invitations_create from './endpoints/invitations/create.js';
import * as ep___invitations_status from './endpoints/invitations/status.js';
import * as ep___invitations_validate from './endpoints/invitations/validate.js';
import * as ep___invitations_details from './endpoints/invitations/details.js';
...
import * as ep___checkout from './endpoints/stripe/checkout.js';
import * as ep___stripe_manage from './endpoints/stripe/manage.js';
import * as ep___stripe_checkout from './endpoints/stripe/webhook.js';
import * as ep___stripe_prices from './endpoints/stripe/prices.js';
...
import * as ep___i_authorizedSessions from './endpoints/i/authorized-sessions.js';
import * as ep___i_authorizedSessions_delete from './endpoints/i/revoke-session.js';
...
import * as ep___i_exportUserData from './endpoints/i/export-user-data.js';
...
import * as ep___i_genalt from './endpoints/i/gen-alt.js';
...
import * as ep___messaging_messages_edit from './endpoints/messaging/messages/edit.js';
import * as ep___messaging_messages_read from './endpoints/messaging/messages/read.js';
import * as ep___messaging_messages_reactions_create from './endpoints/messaging/messages/reactions/create.js';
import * as ep___messaging_messages_reactions_delete from './endpoints/messaging/messages/reactions/delete.js';
import * as ep___messaging_messages_reactions_toggle_reaction from './endpoints/messaging/messages/reactions/toggle-reaction.js';
import * as ep___messaging_encryption_init_keys from './endpoints/messaging/encryption/init-keys.js';
import * as ep___messaging_encryption_decrypt from './endpoints/messaging/encryption/decrypt.js';
import * as ep___messaging_encryption_preferences from './endpoints/messaging/encryption/preferences.js';
import * as ep___messaging_encryption_update_preferences from './endpoints/messaging/encryption/update-preferences.js';
import * as ep___meta from './endpoints/meta.js';
import * as ep___music_nowPlaying from './endpoints/music/now-playing.js';
import * as ep___deco_list from './endpoints/decos-list.js';
...
import * as ep___notes_legacyTimeline from './endpoints/notes/legacy-timeline.js';
...
import * as ep___notes_trending from './endpoints/notes/trending.js';
import * as ep___notes_socialProof from './endpoints/notes/social-proof.js';
...
import * as ep__gif_search from './endpoints/gifbox/search.js';
import * as ep__gif_popular from './endpoints/gifbox/popular.js';
...
import * as ep___oauth_token from './endpoints/oauth/token.js';
...
import * as ep___quickBarks_create from './endpoints/quick-barks/create.js';
import * as ep___quickBarks_delete from './endpoints/quick-barks/delete.js';
import * as ep___quickBarks_timeline from './endpoints/quick-barks/timeline.js';
import * as ep___quickBarks_user from './endpoints/quick-barks/user.js';
import * as ep___quickBarks_viewers from './endpoints/quick-barks/viewers.js';
...
import * as ep___admin_generateMuxSigningKey from './endpoints/admin/generate-mux-signing-key.js';
import * as ep___mux_webhook from './endpoints/live/webhook.js';
import * as ep___mux_make_stream from './endpoints/live/make-stream.js';
import * as ep___mux_get_stream from './endpoints/live/get-stream.js';
import * as ep___live_edit_stream_note from './endpoints/live/add-note.js';
import * as ep___live_health from './endpoints/live/health.js';
import * as ep___live_viewers from './endpoints/live/viewers.js';
import * as ep___live_moderators_add from './endpoints/live/moderators/add.js';
import * as ep___live_moderators_remove from './endpoints/live/moderators/remove.js';
import * as ep___live_moderators_list from './endpoints/live/moderators/list.js';
import * as ep___live_chat_create from './endpoints/live-chat/create.js';
import * as ep___live_chat_delete from './endpoints/live-chat/delete.js';
import * as ep___live_chat_messages from './endpoints/live-chat/messages.js';
import * as ep___gift_check from './endpoints/gift/check.js';
import * as ep___gift_redeem from './endpoints/gift/redeem.js';
import * as ep___gift_listPurchased from './endpoints/gift/list-purchased.js';
import * as ep___gift_verify from './endpoints/gift/verify.js';
import * as ep___subscription_info from './endpoints/subscription/info.js';
import * as ep___subscription_applyGiftCredit from './endpoints/subscription/apply-gift-credit.js';
import * as ep___subscription_settings from './endpoints/subscription/settings.js';
import * as ep___positiveReinforcement_triggerMilestone from './endpoints/positive-reinforcement/trigger-milestone.js';
import * as ep___positiveReinforcement_recognizeContribution from './endpoints/positive-reinforcement/recognize-contribution.js';
import * as ep___positiveReinforcement_provideSupport from './endpoints/positive-reinforcement/provide-support.js';
import * as ep___algorithm_trackUsage from './endpoints/algorithm/track-usage.js';
import * as ep___algorithm_trackInteraction from './endpoints/algorithm/track-interaction.js';
import * as ep___algorithm_diversityFeedback from './endpoints/algorithm/diversity-feedback.js';
import * as ep___algorithm_diversityMetrics from './endpoints/algorithm/diversity-metrics.js';
import * as ep___algorithm_feedback from './endpoints/algorithm/feedback.js';
import * as ep___algorithm_stats from './endpoints/algorithm/stats.js';
import * as ep___algorithm_collectSignals from './endpoints/algorithm/collect-signals.js';
import * as ep___algorithm_abTests from './endpoints/algorithm/ab-tests.js';
import * as ep___algorithm_cleanupDuplicates from './endpoints/algorithm/cleanup-duplicates.js';
import * as ep___firebase_registerToken from './endpoints/firebase/register-token.js';
import * as ep___firebase_unregisterToken from './endpoints/firebase/unregister-token.js';
import * as ep___firebase_testNotification from './endpoints/firebase/test-notification.js';
import * as ep___revenuecat_webhook from './endpoints/revenuecat/webhook.js';

const eps: Array<[string, any]> = [
	['admin/meta', ep___admin_meta],
	['decorations', ep___deco_list],
	...
	['admin/staff-add', ep___admin_staff_add],
	['admin/staff-remove', ep___admin_staff_remove],
	['admin/plus-add', ep___admin_plus_add],
	['admin/plus-remove', ep___admin_plus_remove],
	['admin/translator-add', ep___admin_tanslator_add],
	['admin/translator-remove', ep___admin_tanslator_remove],
	['admin/verify-add', ep___admin_verify_add],
	['admin/verify-remove', ep___admin_verify_remove],
	...
	['admin/subscription/manage', ep___admin_subscription_manage],
	['admin/subscription/cleanup-expired', ep___admin_subscription_cleanupExpired],
	['admin/reset-password', ep___admin_resetPassword],
	['admin/resolve-abuse-user-report', ep___admin_resolveAbuseUserReport],
	['admin/send-email', ep___admin_sendEmail],
	['admin/mass-email', ep___admin_mass_email],
	['admin/make-customer', ep___admin_make_customer],
	['admin/add-trial-user', ep___admin_add_trial_user],
	...
	['admin/deco/edit', ep___admin_deco_edit],
	...
	['barktres/start-session', ep___barktres_startSession],
	['barktres/submit-score', ep___barktres_submitScore],
	['barktres/leaderboard', ep___barktres_leaderboard],
	['barktres/my-scores', ep___barktres_myScores],
	...
	['channels/archive', ep___channels_archive],
	['channels/ban-user', ep___channels_ban_user],
	['channels/pin', ep___channels_pin],
	['channels/un-archive', ep___channels_unarchive],
	['channels/unban-user', ep___channels_unban_user],
	['channels/unpin', ep___channels_unpin],
	['channels/user-role-add', ep___channels_user_role_add],
	['channels/user-role-remove', ep___channels_role_remove],
	['channels/ban-list', ep___channels_ban_list],
	['channels/admin-list', ep___channels_admin_list],
	['channels/mod-list', ep___channels_mod_list],
	...
	['contacts/discover', ep___contacts_discover],
	['contacts/stats', ep___contacts_stats],
	['contacts/import', ep___contacts_import],
	['contacts/inferred-friends', ep___contacts_inferred_friends],
	['invitations/create', ep___invitations_create],
	['invitations/status', ep___invitations_status],
	['invitations/validate', ep___invitations_validate],
	['invitations/details', ep___invitations_details],
	['drive', ep___drive],
	...
	['i', ep___i],
	['plus/checkout', ep___checkout],
	['plus/manage', ep___stripe_manage],
	['stripe/webhook', ep___stripe_checkout],
	['stripe/prices', ep___stripe_prices],
	...
	['i/authorized-sessions', ep___i_authorizedSessions],
	['i/revoke-session', ep___i_authorizedSessions_delete],
	...
	['i/export-user-data', ep___i_exportUserData],
	...
	['messaging/messages/edit', ep___messaging_messages_edit],
	['messaging/messages/read', ep___messaging_messages_read],
	['messaging/messages/reactions/create', ep___messaging_messages_reactions_create],
	['messaging/messages/reactions/delete', ep___messaging_messages_reactions_delete],
	['messaging/messages/reactions/toggle-reaction', ep___messaging_messages_reactions_toggle_reaction],
	['messaging/encryption/init-keys', ep___messaging_encryption_init_keys],
	['messaging/encryption/decrypt', ep___messaging_encryption_decrypt],
	['messaging/encryption/preferences', ep___messaging_encryption_preferences],
	['messaging/encryption/update-preferences', ep___messaging_encryption_update_preferences],
	['messaging/encryption/init-keys', ep___messaging_encryption_init_keys],
	['messaging/encryption/decrypt', ep___messaging_encryption_decrypt],
	['messaging/encryption/preferences', ep___messaging_encryption_preferences],
	['messaging/encryption/update-preferences', ep___messaging_encryption_update_preferences],
	['meta', ep___meta],
	['music/now-playing', ep___music_nowPlaying],
	...
	['notes/hybrid-timeline', ep___notes_legacyTimeline],
	['notes/local-timeline', ep___notes_localTimeline],
	['barks/recommended-timeline', ep___notes_hybridTimeline],
	...
	['notes/trending', ep___notes_trending],
	['notes/social-proof', ep___notes_socialProof],
	...
	['quick-barks/create', ep___quickBarks_create],
	['quick-barks/delete', ep___quickBarks_delete],
	['quick-barks/timeline', ep___quickBarks_timeline],
	['quick-barks/user', ep___quickBarks_user],
	['quick-barks/viewers', ep___quickBarks_viewers],
	['ping', ep___ping],
	...
	['positive-reinforcement/trigger-milestone', ep___positiveReinforcement_triggerMilestone],
	['positive-reinforcement/recognize-contribution', ep___positiveReinforcement_recognizeContribution],
	['positive-reinforcement/provide-support', ep___positiveReinforcement_provideSupport],
	...
	['admin/generate-mux-signing-key', ep___admin_generateMuxSigningKey],
	['fetch-rss', ep___fetchRss],
	['mux/webhook', ep___mux_webhook],
	['live/create', ep___mux_make_stream],
	['live/get', ep___mux_get_stream],
	['live/add-note', ep___live_edit_stream_note],
	['live/health', ep___live_health],
	['live/viewers', ep___live_viewers],
	['live/moderators/add', ep___live_moderators_add],
	['live/moderators/remove', ep___live_moderators_remove],
	['live/moderators/list', ep___live_moderators_list],
	['live-chat/create', ep___live_chat_create],
	['live-chat/delete', ep___live_chat_delete],
	['live-chat/messages', ep___live_chat_messages],
	['gift/check', ep___gift_check],
	['gift/redeem', ep___gift_redeem],
	['gift/list-purchased', ep___gift_listPurchased],
	['gift/verify', ep___gift_verify],
	['subscription/info', ep___subscription_info],
	['subscription/apply-gift-credit', ep___subscription_applyGiftCredit],
	['subscription/settings', ep___subscription_settings],
	['algorithm/track-usage', ep___algorithm_trackUsage],
	['algorithm/track-interaction', ep___algorithm_trackInteraction],
	['algorithm/diversity-feedback', ep___algorithm_diversityFeedback],
	['algorithm/diversity-metrics', ep___algorithm_diversityMetrics],
	['algorithm/feedback', ep___algorithm_feedback],
	['algorithm/stats', ep___algorithm_stats],
	['algorithm/collect-signals', ep___algorithm_collectSignals],
	['algorithm/ab-tests', ep___algorithm_abTests],
	['algorithm/cleanup-duplicates', ep___algorithm_cleanupDuplicates],
	['firebase/register-token', ep___firebase_registerToken],
	['firebase/unregister-token', ep___firebase_unregisterToken],
	['firebase/test-notification', ep___firebase_testNotification],
	['revenuecat/webhook', ep___revenuecat_webhook],
];
...
export interface IEndpointMeta {
	...
	/**
	 * Whether this endpoint requires elevated privileges and can receive headers directly
	 * If not specified, it defaults to false
	 */
	readonly requiresElevated?: boolean;
}
...
const endpoints: IEndpoint[] = eps.map(([name, ep]): IEndpoint => {
	// Type guard to ensure ep is an object with the expected properties
	if (typeof ep === 'string' || !ep || typeof ep !== 'object') {
		console.error(`Invalid endpoint module for ${String(name)}:`, ep);
		throw new Error(`Invalid endpoint module: ${String(name)}`);
	}

	return {
		name: String(name),
		exec: (ep as any).default,
		meta: (ep as any).meta || {},
		params: (ep as any).paramDef,
	};
});
