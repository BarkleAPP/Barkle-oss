...
export default define(meta, paramDef, async (ps, me) => {
  ...
  switch (ps.sort) {
    ...
    case '+isTranslator': query.orderBy('user.isTranslator', 'DESC'); break;
    case '-isTranslator': query.orderBy('user.isTranslator', 'ASC'); break;
    case '+isPlus': query.orderBy('user.isPlus', 'DESC'); break;
    case '-isPlus': query.orderBy('user.isPlus', 'ASC'); break;
    case '+isVerified': query.orderBy('user.isVerified', 'DESC'); break;
    case '-isVerified': query.orderBy('user.isVerified', 'ASC'); break;
    case '+isSilenced': query.orderBy('user.isSilenced', 'DESC'); break;
    case '-isSilenced': query.orderBy('user.isSilenced', 'ASC'); break;
    case '+isSuspended': query.orderBy('user.isSuspended', 'DESC'); break;
    case '-isSuspended': query.orderBy('user.isSuspended', 'ASC'); break;
