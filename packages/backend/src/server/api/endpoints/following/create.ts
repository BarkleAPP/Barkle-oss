...
export const paramDef = {
	...
	properties: {
		...
		fromInvitation: { type: 'boolean', default: false },
	},
	required: ['userId'],
} as const;
...
export default define(meta, paramDef, async (ps, user) => {
	...
	try {
		await create(follower, followee, ps.fromInvitation);

		// Track follow signal for algorithm learning
		try {
		...
		if (e instanceof IdentifiableError) {
			...
			if (e.id === '3338292a-f764-498d-8855-db939dcf8c48') throw new ApiError(meta.errors.blocked);
		}
		throw e;
	}
