...
import { Ads, Emojis, Users, Decorations } from '@/models/index.js';
...
export default define(meta, paramDef, async (ps, me) => {
	...
	const response: any = {
		...
		decorations: instance.privateMode && !me ? [] : await Decorations.packMany(decorations),
	...
	if (ps.detail) {
		...
		response.features = {
			...
			spotify: instance.enableSpotifyIntegration,
			lastfm: instance.enableLastfmIntegration,
