...
export class UserProfile {
	...
	@Column('varchar', {
		...
		comment: 'Profile css of the user',
	})
	public profileCss: string | null;
	...
	@Column('boolean', {
		default: true,
		comment: 'Whether to receive social reminder notifications (push/firebase).',
	})
	public receiveSocialReminders: boolean;

	@Column('boolean', {
		default: true,
		comment: 'Whether to receive reminder notifications via email.',
	})
	public receiveEmailReminders: boolean;
	...
	public lastfmUsername: string | null;
