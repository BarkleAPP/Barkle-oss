...
import { QuickBarkRepository } from './repositories/quick-bark.js';
import { MessagingMessageRepository } from './repositories/messaging-message.js';
import { MessagingMessageReactionRepository } from './repositories/messaging-message-reaction.js';
...
import { DecorationsRepository } from './repositories/decorations.js';
...
import { StreamsRepository } from './repositories/streams.js';
import { GiftedSubscriptionRepository } from './repositories/gifted-subscription.js';
import { LiveChatMessagesRepository } from './repositories/live-chat-message.js';
import { StreamModeratorsRepository } from './repositories/stream-moderators.js';
import { UserEncryptionKey } from './entities/user-encryption-key.js';
import { MessageEncryptionKey } from './entities/message-encryption-key.js';
import { UserEncryptionPreference } from './entities/user-encryption-preference.js';
import { UserMusicIntegration } from './entities/user-music-integration.js';
import { ContactImportRepository } from './repositories/contact-import.js';
import { UserAlgorithmPreferencesRepository } from './repositories/user-algorithm-preferences.js';
import { ContactDegreeOfSeparationRepository } from './repositories/contact-degree-separation.js';
import { FirebaseTokenRepository } from './repositories/firebase-token.js';
import { NotificationScheduleRepository } from './repositories/notification-schedule.js';
import { InvitationTrackingRepository } from './repositories/invitation-tracking.js';
import { UserBehavioralData } from './entities/user-behavioral-data.js';
import { UserAlgorithmProfile } from './entities/user-algorithm-profile.js';
import { ContentAlgorithmFeatures } from './entities/content-algorithm-features.js';
import { TimelineCache } from './entities/timeline-cache.js';
import { StripeEvent } from './entities/stripe-event.js';
import { WebhookEvent } from './entities/webhook-event.js';
import { AlgorithmExperiment } from './entities/algorithm-experiment.js';
...
export const UserMusicIntegrations = db.getRepository(UserMusicIntegration);
...
export const Decorations = (DecorationsRepository);
...
export const MessagingMessageReactions = (MessagingMessageReactionRepository);
...
export const Streams = StreamsRepository;
export const GiftedSubscriptions = (GiftedSubscriptionRepository); // Use the repository
export const LiveChatMessages = LiveChatMessagesRepository;
export const StreamModerators = StreamModeratorsRepository;
export const UserEncryptionKeys = db.getRepository(UserEncryptionKey);
export const MessageEncryptionKeys = db.getRepository(MessageEncryptionKey);
export const UserEncryptionPreferences = db.getRepository(UserEncryptionPreference);
export const ContactImports = ContactImportRepository;
export const UserAlgorithmPreferences = UserAlgorithmPreferencesRepository;
export const ContactDegreeOfSeparations = ContactDegreeOfSeparationRepository;
export const FirebaseTokens = FirebaseTokenRepository;
export const NotificationSchedules = NotificationScheduleRepository;
export const InvitationTrackings = InvitationTrackingRepository;
export const UserBehavioralDatas = db.getRepository(UserBehavioralData);
export const UserAlgorithmProfiles = db.getRepository(UserAlgorithmProfile);
export const ContentAlgorithmFeaturesRepository = db.getRepository(ContentAlgorithmFeatures);
export const TimelineCaches = db.getRepository(TimelineCache);
export const StripeEvents = db.getRepository(StripeEvent);
export const WebhookEvents = db.getRepository(WebhookEvent);
export const AlgorithmExperiments = db.getRepository(AlgorithmExperiment);
export const UserAlgorithmExperiments = db.getRepository(UserAlgorithmExperiment);
