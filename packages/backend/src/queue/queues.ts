...
import { DeliverJobData, InboxJobData, DbJobData, ObjectStorageJobData, EndedPollNotificationJobData, WebhookDeliverJobData, SubscriptionJobData } from './types.js';
...
export const firebaseNotificationQueue = initializeQueue<Record<string, unknown>>('firebaseNotification');
...
export const subscriptionQueue = initializeQueue<SubscriptionJobData>('subscription');
