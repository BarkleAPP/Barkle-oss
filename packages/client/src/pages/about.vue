			...
			<swiper-slide>
				<div class="_formRoot">
					<div class="_formBlock fwhjspax" :style="{ backgroundImage: `url(${ $instance.bannerUrl })` }">
						<div class="content">
							<img :src="$instance.iconUrl || $instance.faviconUrl || '/favicon.ico'" :alt="($instance.name || host) + ' instance icon'" class="icon"/>
							<div class="name">
					...
					<FormSection>
						<MkKeyValue class="_formBlock" :copy="version">
							<template #key>Barkle</template>
							<template #value>{{ version }}</template>
						</MkKeyValue>
						<FormLink to="/about-barkle">{{ i18n.ts.aboutMisskey }}</FormLink>
					</FormSection>
