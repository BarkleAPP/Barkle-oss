...
<div class="_formRoot">
	...
	<FormSection>
		...
		<FormSwitch v-model="barkleForToggle" class="_formBlock" @update:modelValue="save()">{{ i18n.ts.barkleForToggle }}</FormSwitch>
...
let barkleForToggle = $computed(defaultStore.makeGetterSetter('barkleForToggle'));
