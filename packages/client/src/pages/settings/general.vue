...
<div class="_formRoot">
	<FormSelect v-model="lang" class="_formBlock">
		...
		<template #caption>
			<I18n :src="i18n.ts.i18nInfo" tag="span">
				<template #link>
					<MkLink url="https://barkle.chat/channels/9vjz8ig95v">Barkle Translate</MkLink>
				</template>
			</I18n>
		</template>
	</FormSelect>
	...
	<FormSection>
		...
		<FormSwitch v-model="renderProfileCSS" class="_formBlock">{{ i18n.ts.renderProfileCSS }}</FormSwitch>
...
const renderProfileCSS = computed(defaultStore.makeGetterSetter('renderProfileCSS'));
