	...
	<div class="top">
		...
		<div class="main">
			...
			<div class="action">
				...
				<MkButton class="explore" inline @click="explore()">{{ i18n.ts.explore }}</MkButton>
			</div>
		...
		<img src="/client-assets/misskey.svg" class="misskey" alt="Barkle Logo"/>
	</div>
</div>
</template>
	...
	methods: {
		...
		showMenu(ev) {
			os.popupMenu([{
				...
				text: i18n.ts.aboutBarkle,
				icon: 'ph-info-bold ph-lg',
				action: () => {
					os.pageWindow('/about-barkle');
				}
