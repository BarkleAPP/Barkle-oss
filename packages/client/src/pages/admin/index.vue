...
const menuDef = $computed(() => [{
	...
	items: [{
		...
		to: '/admin/decos',
		active: currentPage?.route.name === 'decos',
	}, {
	...
	items: [{
		...
		icon: 'ph-envelope-simple-open-bold ph-lg',
		text: i18n.ts.massEmail,
		to: '/admin/mass-email',
		active: currentPage?.route.name === 'mass-email',
	},  {
		icon: 'ph-cloud-bold ph-lg',
		...
		text: i18n.ts.liveStreamingSettings,
		to: '/admin/live-streaming',
		active: currentPage?.route.name === 'live-streaming',
	}],
}, {
	title: 'Algorithm',
	items: [{
		...
		to: '/admin/algorithm-stats',
		active: currentPage?.route.name === 'algorithm-stats',
	}, {
		icon: 'ph-flask-bold ph-lg',
		text: 'A/B Tests',
		to: '/admin/algorithm-ab-tests',
		active: currentPage?.route.name === 'algorithm-ab-tests',
	}],
}] : []), {
	title: i18n.ts.info,
	items: [{
