import { AsyncComponentLoader, defineAsyncComponent, inject, computed } from 'vue';
...
export const routes = [{
	...
	path: '/@:acct/live',
	name: 'user-live',
	component: page(() => import('./pages/user/live.vue')),
	props: true,
}, {
	name: 'user',
	path: '/@:acct/:page?',
	...
	children: [{
		...
		path: '/decorations',
		name: 'decorations',
		component: page(() => import('./pages/settings/decoration.vue')),
	}, {
		path: '/subscribe',
		name: 'subscribe',
		component: page(() => import('./pages/settings/subscribe.vue')),
	}, {
		path: '/manage-plus',
		name: 'manage-plus',
		component: page(() => import('./pages/settings/manage-plus.vue')),
	}, {
		path: '/privacy',
		name: 'privacy',
		...
		component: page(() => import('./pages/settings/authorized-apps.vue')),
	}, {
		path: '/apps',
		name: 'api',
		...
		path: '/live',
		name: 'live',
		component: page(() => import('./pages/settings/live.vue')),
	}, {
		path: '/settings/my-gifts',
		name: 'my-gifts',
		component: page(() => import('./pages/settings/MyGifts.vue')),
	}, {
		path: '/my-gifts',
		name: 'my-gifts-redirect',
		component: page(() => import('./pages/settings/MyGifts.vue')),
	}, {
		path: '/invitation-analytics',
		name: 'invitation-analytics',
		component: page(() => import('./pages/settings/invitation-analytics.vue')),
	}, {
		path: '/',
	...
	path: '/stripe/success',
	component: page(() => import('./pages/plusSuccess.vue')),
	props: route => ({
		sessionId: route.query.session_id,
		plan: route.query.plan || route.params.plan,
		isGift: route.query.session_id ? true : false
	})
}, {
	path: '/stripe/failed',
	component: page(() => import('./pages/plusFailed.vue')),
	props: route => ({ plan: route.query.plan || route.params.plan })
}, {
	path: '/stripe/cancelled',
	component: page(() => import('./pages/plusCancelled.vue')),
	props: route => ({ plan: route.query.plan || route.params.plan })
}, {
	path: '/gift/purchase',
	component: page(() => import('./pages/gift/purchase.vue')),
}, {
	path: '/gift/redeem/:token?',
	component: page(() => import('./pages/gift/redeem/index.vue')),
}, {
	path: '/gift/verify/:token',
	component: page(() => import('./pages/gift/verify.vue')),
}, {
	path: '/about',
	...
	path: '/about-barkle',
	component: page(() => import('./pages/about-barkle.vue')),
}, {
	path: '/barktres',
	component: page(() => import('./pages/barktres.vue')),
}, {
	path: '/theme-editor',
	...
	path: '/onboarding/follow-suggestions',
	component: page(() => import('./pages/onboarding/follow-suggestions.vue')),
	loginRequired: true,
}, {
	path: '/invite-friends',
	component: page(() => import('./pages/invite-friends.vue')),
	loginRequired: true,
}, {
	path: '/invite/:code',
	...
	children: [{
		...
		path: '/decos',
		name: 'decos',
		component: page(() => import('./pages/admin/decos.vue')),
	}, {
		path: '/federation',
		name: 'federation',
		...
		path: '/mass-email',
		name: 'mass-email',
		component: page(() => import('./pages/admin/mass-email.vue')),
	}, {
		path: '/object-storage',
		name: 'object-storage',
		...
		path: '/live-streaming',
		name: 'live-streaming',
		component: page(() => import('./pages/admin/live-streaming.vue')),
	}, {
		path: '/algorithm-stats',
		name: 'algorithm-stats',
		component: page(() => import('./pages/admin/algorithm-stats.vue')),
	}, {
		path: '/algorithm-ab-tests',
		name: 'algorithm-ab-tests',
		component: page(() => import('./pages/admin/algorithm-ab-tests.vue')),
	}, {
		path: '/other-settings',
		name: 'other-settings',
...
export function useRoute() {
	...
	return {
		params: computed(() => {
			const props = router.current?.props;
			if (!props) return {};
		...
		path: computed(() => router.currentPath),
