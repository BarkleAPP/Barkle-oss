...
<div :class="[$style.root, { yellow: user.isSilenced, red: user.isSuspended, gray: false }]">
	...
	<div class="body">
		...
		<span class="sub">
			...
			<span v-if="user.socialProof?.mutualConnections > 0" class="mutual-connections">
				<i class="fas fa-users"></i>
				{{ user.socialProof.mutualConnections }}
			</span>
