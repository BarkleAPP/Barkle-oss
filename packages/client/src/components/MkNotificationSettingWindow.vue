<template>
	<XModalWindow ref="dialog" :width="400" :height="450" :with-ok-button="true" :ok-button-disabled="false" @ok="ok()"
		...
		<div class="_monolithic_">
			<div class="_section">
				<MkSwitch v-model="receiveSocialReminders">
			...
			<div v-if="!useGlobalSetting" class="_section">
				...
				<MkSwitch v-for="ntype in notificationTypes" :key="ntype" v-model="typesMap[ntype]">{{
...
let receiveSocialReminders = $ref($i?.receiveSocialReminders ?? true);
...
function ok() {
	// Save social reminders setting
	os.api('i/update', {
		receiveSocialReminders: receiveSocialReminders,
	});
