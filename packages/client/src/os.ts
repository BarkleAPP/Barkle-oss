...
export function openGifPicker(src: any, opts = {}, onSelected: (gif: any) => void) {
	return new Promise((resolve) => {
	  popup(defineAsyncComponent(() => import('@/components/BkGifPickerDialog.vue')), {
		src,
		...opts,
		onSelect: (gif: any) => {
		  onSelected(gif);
...
export { selectFile, selectFiles } from '@/scripts/select-file';
export { stream };
export { refreshAccount as reloadAccount };
