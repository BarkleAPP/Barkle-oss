 ...
 * Gulp tasks
 * 
 * Note: CSS minification is configured conservatively to prevent breaking
 * CSS custom properties (variables), complex selectors, and duplicate rules
 * that may have different contexts. This ensures the CSS works correctly
 * while still providing basic minification benefits.
 */
...
gulp.task('build:backend:style', () => {
	// Remove CSS cleaning/minification that was breaking UI functionality
	// Simply copy CSS files without any processing to preserve all features
