...
> **Open Source**: Barkle is an open-source social platform, forked from [Misskey](https://github.com/misskey-dev/misskey) and released under the GNU General Public License v3.0. We acknowledge and thank the Misskey development team for creating the foundation this project builds upon.
...
Barkle is licensed under the GNU General Public License v3.0 - see the [LICENSE](LICENSE) file for details.

### Attribution

This project is built upon [Misskey](https://github.com/misskey-dev/misskey), an open-source decentralized social platform. We are grateful to the Misskey development team and contributors for creating the foundation that made this project possible.

**Misskey License**: GNU Affero General Public License v3.0  
**Misskey Repository**: https://github.com/misskey-dev/misskey

## 🔗 Links

- **Main Repository**: https://github.com/BarkleAPP/Barkle-oss
- **Upstream (Misskey)**: https://github.com/misskey-dev/misskey
